...
public class MenuProductos {
	...
	public MenuProductos(@JsonProperty(value="nombre")String pNom, @JsonProperty(value="categoria")Integer pCat,
			...
			@JsonProperty(value="restaurante_nombre")String a, @JsonProperty(value="isMenu")Boolean ismenu, @JsonProperty(value="isProducto")Boolean isprod,
			@JsonProperty(value="producto_nombre")String prodnombrr) {
		super();
		nombre=pNom;
		categoria=pCat;
		precioVenta=pVenta;
